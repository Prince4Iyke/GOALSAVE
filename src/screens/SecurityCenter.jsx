  ...
  return (
    <Screen nav active="profile" onNavigate={goToTab}>
      ...
      <div style={{ marginBottom: 18 }}>
        {[
          { l: "Biometric Login", icon: Fingerprint, on: biometricEnabled, toggle: () => setBiometricEnabled((v) => !v) },
          { l: "Two-Factor Authentication", icon: Lock, on: twoFactorEnabled, toggle: () => setTwoFactorEnabled((v) => !v) },
