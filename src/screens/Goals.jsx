...
export default function Goals() {
  ...
  `}</style>
      ...
      <div style={{ borderRadius: 16, padding: 16, background: CARD_GRADIENT, marginBottom: 18 }}>
        ...
        <input value={contribAmount} onChange={(e) => setContribAmount(e.target.value.replace(/\D/g, ""))} placeholder="Amount to add" style={{ width: "80%", margin: "20px 30px 0", border: "1px, solid rgba(255,255,255,0.5)", background: "rgba(255,255,255,0.15)", borderRadius: 10, padding: 10, color: "#fff", fontWeight: 700, outline: "none" }} />
        <button
          onClick={() => {
