...
export default function Splash() {
  ...
  return (
    <div style={{ height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", background: C.card, padding: 24 }}>
      <img
        src={logo}
        alt="GoalSave logo"
        style={{ width: 200, height: "auto", objectFit: "contain" }}
      />
      <div style={{ marginTop: 40, border: `2px solid ${C.navy}`, borderRadius: 12, padding: "10px 26px" }}>
