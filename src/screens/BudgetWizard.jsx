      ...
      {budgetStep === 3 && (
        <div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", border: `1px solid ${SOFT_BORDER}`, borderRadius: 10, padding: 12, marginTop: 16 }}>
            <div><div style={{ fontFamily: FONT, fontSize: 11, color: C.textMuted }}>Total Allocation</div><div style={{ fontFamily: FONT, fontWeight: 700, color: "#000" }}>{fmtNShort(totalAllocated)}</div></div>
            <div style={{ textAlign: "right" }}><div style={{ fontFamily: FONT, fontSize: 11, color: C.textMuted }}>Remaining</div><div style={{ fontFamily: FONT, fontWeight: 700, color: "#000" }}>{fmtNShort(Math.max(0, income - totalAllocated))}</div></div>
          </div>
      ...
      {budgetStep === 4 && (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", paddingTop: 20 }}>
          ...
          <div style={{ width: "100%", border: `1px solid ${SOFT_BORDER}`, borderRadius: 10, padding: 16, marginTop: 20, textAlign: "left" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 10 }}><span style={{ fontFamily: FONT, color: C.textMuted, fontSize: 13 }}>Total Budget</span><b style={{ fontFamily: FONT, color: "#000" }}>{fmtNShort(totalAllocated || 215000)}</b></div>
